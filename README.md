...
### 方法一：直接開啟專案
1. 安裝 [Visual Studio 2022](https://visualstudio.microsoft.com/)（需含 .NET 桌面開發工作負載）
2. Clone 此專案：
   ```
   git clone https://github.com/你的帳號/AccountingSystem.git
   ```
3. 開啟 `AccountingSystem.sln`
4. 在「方案總管」右鍵點選專案 → 「管理 NuGet 套件」→ 安裝 `System.Data.SQLite`
5. 按 **F5** 執行
